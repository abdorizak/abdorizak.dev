...
export default function ContactButtons() {
  return (
    <div className={'flex flex-wrap items-center gap-16'}>
      <ButtonLink
        title={'Compose an email to Abdorizak'}
        href={'mailto:cabdirizaaqyare12@gmail.com?subject=Hi%20Abdorizak!'}
        outlined
      ...
      <ButtonLink
        title={'Compose a Twitter direct message for Abdorizak'}
        href={'https://twitter.com/abdorizak3'}
        outlined
      ...
      <ButtonLink
        title={"Abdorizak's Telegram profile"}
        href={'https://t.me/abdorizak'}
        outlined
