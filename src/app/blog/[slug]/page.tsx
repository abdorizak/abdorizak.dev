        ...
        >
          <div className={'flex gap-12'}>
            ...
            <ButtonLink
              ...
              href={`https://github.com/abdorizak/abdorizak.dev/edit/main/content/${post.slug}.mdx`}
            >
...
export async function generateMetadata(
  ...
  const metadata = getStaticMetadata({
    title: `${title} | Blog – Abdorizak Abdalla`,
    description: excerpt || 'Blog post by Abdorizak Abdalla',
    image: ogImage,
