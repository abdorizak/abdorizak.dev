...
export const metadata = createMetadata({
  title: 'Blog – Abdirizak Abdalla',
  description:
    // eslint-disable-next-line max-len
    'Blog posts by Abdirizak Abdalla. Here I share some thoughts, stories, information and more about software development, programming, tech or my personal life',
