  ...
  return (
    <Section id={'dashboard'}>
      ...
      >
        ...
        <StyledStatCard
          title={'More links'}
          href={'https://links.abdorizak.dev'}
          className={cx(
...
export const metadata = getStaticMetadata({
  title: 'Dashboard – Abdorizak Abdalla',
  description:
    // eslint-disable-next-line max-len
    "Get to know the latest stats and what I'm currently listening to on doing.",
  exactUrl: 'https://abdorizak.dev/dashboard',
  keywords: [
    'dashboard',
    'iOS',
    'statistics',
