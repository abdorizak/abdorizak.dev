...
export const CodeImage = () => (
  <figure>
    ...
    >
      <CodeImg
        src={lightCode}
        alt={"Preview of abdorizak's VSCode configuration with Light theme"}
        quality={100}
        placeholder={'blur'}
      ...
      <CodeImg
        src={darkCode}
        alt={"Preview of abdorizak's VSCode configuration with Dark theme"}
        quality={100}
        placeholder={'blur'}
    ...
    <figcaption>Preview of abdorizak&apos;s VSCode configuration</figcaption>
  </figure>
);
